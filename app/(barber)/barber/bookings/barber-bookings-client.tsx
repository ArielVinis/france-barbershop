...
import { updateBookingStatus } from "@/app/_features/barber/_actions/update-booking-status"
...
type BookingWithRelations = Awaited<
  ReturnType<
    typeof import("@/app/_features/barber/_data/get-barber-bookings").getBarberBookings
  >
>[number]
